...
remaining_utf8_bytes(utf8_byte_t first_byte){
 ...
 get_utf8_decoding_function(size_t size,utf8_glyph_t glyph){
    ...
    switch(size) {
        ...
        case 2:
            return (utf8_decoding_func_t)(long)utf8_two_byte_decode(glyph);
        case 3:
            return (utf8_decoding_func_t)(long)utf8_three_byte_decode(glyph);
        case 4:
            return (utf8_decoding_func_t)(long)utf8_four_byte_decode(glyph);
    }
    return NULL;
 }
